...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@VSTU.COM</a></li>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Test <span>TEST</span><p class="logo_w3l_agile_caption">HOTEL</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#team" class="menu__link scroll">None</a></li>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">TEST</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">TEST some labels here:)</p>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="image1/teams1.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="image1/teams2.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="image1/teams3.jpg" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="image1/teams4.jpg" alt=" " class="img-responsive" />
					</li>
					</ul>
					<div class="resp-tabs-container">
					<div class="tab1">
						<div class="col-md-6 team-Info-agileits">
							<h4>Vitali Vasilchuk</h4>
							<span>Developer</span>
							<p>123</p>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>telnum</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@VSTU.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Address</p>
			...
			<iframe src="https://www.google.com/maps/place/Витебский+государственный+технологический+университет/@55.1781968,30.2329833,17z/data=!3m1!4b1!4m5!3m4!1s0x46c57146d84e92c5:0xebf903f6b2658c6!8m2!3d55.1781968!4d30.2351773?hl=ru-RU" ></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p>© 2020 RGR VSRPP | Design by <a href="index.php">VitV</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
